...
COMPOSABLE_ELEMENTS = ("audio", "ref-clip", "asset-clip")
...
class FcpxXml(object):
    ...
    def _timing_clip(self, clip):
        while clip.tag not in ("clip", "asset-clip", "ref-clip"): #, "sync-clip"):
    ...
    def _time_range(self, element, format_id):
        # print element
        # print format_id
        # print element.get("start", "0s")
        # print self._format_frame_rate(format_id)

...
try:
    ...
    import xmlrpc as xmlrpclib, os, getpass, shutil, http.client as httplib, sys, urllib, types, hashlib
...
class TacticServerStub(object):
    ...
    def get_types_from_instance(my, instance_type):
        '''API Function: get the connector types from an instance type
    ...
    def connect_sobjects(my, src_sobject, dst_sobject, context='default'):
        '''API Function: connect two sobjects together
    ...
    def get_connected_sobjects(my, src_sobject, context='default'):
        '''API Function: get all of the connected sobjects
    ...
    def get_connected_sobject(my, src_sobject, context='default'):
        '''API Function: get the connected sobject
    ...
    def get_plugin_dir(my, plugin):
        ...
        Returns the web path for the specfied plugin

...
set_target_properties(hdf5-shared PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libhdf5-shared.so.1.10.0"
  IMPORTED_SONAME_NOCONFIG "libhdf5-shared.so.100.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS hdf5-shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_hdf5-shared "${_IMPORT_PREFIX}/lib/libhdf5-shared.so.1.10.0" )
...
set_target_properties(hdf5_hl-shared PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libhdf5_hl-shared.so.1.10.0"
  IMPORTED_SONAME_NOCONFIG "libhdf5_hl-shared.so.100.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS hdf5_hl-shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_hdf5_hl-shared "${_IMPORT_PREFIX}/lib/libhdf5_hl-shared.so.1.10.0" )
...
set_target_properties(hdf5_cpp-shared PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libhdf5_cpp-shared.so.1.10.0"
  IMPORTED_SONAME_NOCONFIG "libhdf5_cpp-shared.so.100.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS hdf5_cpp-shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_hdf5_cpp-shared "${_IMPORT_PREFIX}/lib/libhdf5_cpp-shared.so.1.10.0" )
...
set_target_properties(hdf5_hl_cpp-shared PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libhdf5_hl_cpp-shared.so.1.10.0"
  IMPORTED_SONAME_NOCONFIG "libhdf5_hl_cpp-shared.so.100.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS hdf5_hl_cpp-shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_hdf5_hl_cpp-shared "${_IMPORT_PREFIX}/lib/libhdf5_hl_cpp-shared.so.1.10.0" )
